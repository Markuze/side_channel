...
#define Nb 4             ///// Do not change this parameters
#define Nk 4            ///// Do not change this parameters
#define Nr 10           ///// Do not change this parameters
#define NSAMPLES 5000   
#define TARGETBYTE 4    ///// You can put your choice of targetbyte here.
...
int PowerTrace[12];   /// We are considering that every leakage trace will have 12 leakage points, 
						/// one for the plauntext, one for the first round key and 10 for 10 rounds, you can
						// vary this
int doPrint;
...
void ComputeHammingWeight(int round)
{
/*
	int i,j;
	for(i=0;i<4;i++)
...
*/
	int i = (TARGETBYTE >> 2);
	int j = (TARGETBYTE & 3);
	PowerTrace[round] = count_bits(state[i][j]);
	if (PowerTrace[round] > 8)
		printf("Round %d) => %d (%d)\n", round, PowerTrace[TARGETBYTE], state[i][j]);
}
...
void Cipher()
{
	...
	// You can generate the leakage value of the plaintext here
	...
	//You can generate the leakage value of the first roundkey xor operation here
	...
	for(round=1;round<Nr;round++)
	{
		...
		//// You can compute the leakage value of initial 9 round here
	...
	//// You can compute the leakage value of the last round here
